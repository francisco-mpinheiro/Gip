...
router.get('/search', authenticate, searchCtrl.search);
...
router.patch(
  ...
  authenticate,
  authorize(...ADMIN_ROLES),
  usersCtrl.toggleActive
);

router.delete(
  '/users/:id',
  authenticate,
  authorize(ROLES.ADMIN_PLATFORM),
  usersCtrl.delete
);
...
router.get(
  '/tasks/:id/comments',
  authenticate,
  tasksCtrl.getComments
);

router.post(
  '/tasks/:id/comments',
  authenticate,
  tasksCtrl.addComment
);
...
router.post(
  ...
  authenticate,
  upload.single('file'),
  tasksCtrl.addAttachment
);

router.delete(
  '/tasks/:id/attachments/:attachmentId',
  authenticate,
  tasksCtrl.deleteAttachment
);
...
router.get(
  '/notifications',
  authenticate,
  notificationsCtrl.getAll
);

router.patch(
  '/notifications/read-all',
  authenticate,
  notificationsCtrl.markAllAsRead
);

router.patch(
  '/notifications/:id/read',
  authenticate,
  notificationsCtrl.markAsRead
);
